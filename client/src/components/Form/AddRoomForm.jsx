      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className=" flex  gap-4 p-4 bg-white w-full  m-auto rounded-lg">
              <div className="file_upload flex-1 px-5 py-3  border-4 border-dotted border-gray-300 rounded-lg">
              ...
              <div className="h-16 w-16 rounded-sm object-cover overflow-hidden flex items-center ">
                {imagePreview ? (
                  <img src={imagePreview} />
                ) : (
                  <img src={plaseHolderImage} />
                )}
              </div>
            </div>
